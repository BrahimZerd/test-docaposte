...
const manageUser = (props : any) => {
  ...
  const { addUser, deletingUser, buttonText, isOpen, manageUserTitle, userId, params } = props
  ...
  useEffect(() =>  {
    ...
    //ne pas utiliser les parametres !!!! 
    if(params !== undefined) {
      setOpen(true)
    }
  },[params])
  ...
  const onSubmit= (data : FormData) => {
    ...
    return(
        ...
        <CustomizedSnackbars title='Succès' icon={<CheckCircleRoundedIcon color={'success'} style={{marginTop:'3px'}}/>} message="L'utilisateur a été modifié avec succès" />
       }
        {updateMutation.isError && 
       <CustomizedSnackbars title='Echec' icon={<CancelRoundedIcon color={'error'} style={{marginTop:'3px'}}/>} message="La modification de l'utilisateur a échoué" />
        ...
        <></>
         ...
         {newUser.isSuccess &&
         <CustomizedSnackbars title='Succès' icon={<CheckCircleRoundedIcon color={'success'} style={{marginTop:'3px'}}/>} message="L'utilisateur a été ajouté avec succès" />
        }
        {newUser.isError &&
         <CustomizedSnackbars title='Echec' icon={<CancelRoundedIcon color={'error'} style={{marginTop:'3px'}}/>} message="L'ajout de l'utilisateur a échoué" />
         }
         {deleteUserMutation.isSuccess &&
          <CustomizedSnackbars title='Succès' icon={<CheckCircleRoundedIcon color={'success'} style={{marginTop:'3px'}}/>} message="L'utilisateur a été supprimé avec succès" />
         }
        {deleteUserMutation.isError &&
          <CustomizedSnackbars title='Echec' icon={<CancelRoundedIcon color={'error'} style={{marginTop:'3px'}}/>} message="La suppression de l'utilisateur a échoué" />
          }
